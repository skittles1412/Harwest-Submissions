...
public class Main {
	static class TaskAdapter implements Runnable {
		...
		public void run() {
			...
			A1BinaryTableEasyVersion solver = new A1BinaryTableEasyVersion();
	...
	static class A1BinaryTableEasyVersion {
		ArrayList<Pair<Integer, Integer>> ans;
		int[][] arr;

		public A1BinaryTableEasyVersion() {
		}
