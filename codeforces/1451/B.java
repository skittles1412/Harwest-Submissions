...
public class Main {
	static class TaskAdapter implements Runnable {
		...
		public void run() {
			...
			BNonSubstringSubsequence solver = new BNonSubstringSubsequence();
	...
	static class BNonSubstringSubsequence {
		public BNonSubstringSubsequence() {
		}
		...
		public void solve(int kase, InputReader in, Output pw) {
			...
			while(q-->0) {
				...
				boolean valid = false;
				for(int i = 0; i<l; i++) {
					valid |= s.charAt(i)==s.charAt(l);
				}
				for(int i = r+1; i<n; i++) {
					valid |= s.charAt(i)==s.charAt(r);
				}
