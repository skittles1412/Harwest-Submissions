...
public class Main {
	static class TaskAdapter implements Runnable {
		...
		public void run() {
			...
			DDivideAndSummarize solver = new DDivideAndSummarize();
	...
	static class DDivideAndSummarize {
		long[] arr;
		long[] psum;
		TreeMap<Long, Integer> last;
		HashSet<Long> hs;

		public DDivideAndSummarize() {
		}

		public void solve(int l, int r) {
//			Utilities.Debug.dbg(l, r);
			hs.add(psum[r+1]-psum[l]);
			if(l<r) {
				int mid = last.floorEntry((arr[l]+arr[r])/2).getValue();
				if(mid<r) {
					solve(l, mid);
				}
				solve(mid+1, r);
