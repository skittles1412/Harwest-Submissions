...
public class Main {
	...
	static class CIceCave {
		...
		public boolean valid(int x, int y) {
			return x>=0&&y>=0&&x<n&&y<m&&!visited[x][y]&&arr[x][y];
		}

		public void solve(int kase, InputReader in, Output pw) {
			n = in.nextInt();
			m = in.nextInt();
			arr = in.nextBooleanChar(n, o -> o=='.');
